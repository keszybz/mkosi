...
class Installer(DistributionInstaller):
    ...
    @classmethod
    @listify
    def repository_variants(cls, config: MkosiConfig, repo: str) -> Generator[Repo, None, None]:
    ...
    @classmethod
    @listify
    def repositories(cls, config: MkosiConfig, release: int) -> Generator[Repo, None, None]:
        if config.local_mirror:
    ...
    @classmethod
    @listify
    def epel_repositories(cls, config: MkosiConfig) -> Generator[Repo, None, None]:
    ...
    @classmethod
    @listify
    def sig_repositories(cls, config: MkosiConfig) -> Generator[Repo, None, None]:
        if config.local_mirror:
            return
